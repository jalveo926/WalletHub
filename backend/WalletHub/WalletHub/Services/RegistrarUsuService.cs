...
{
    public class RegistrarUsuService : IRegistrarUsuService
    {
        private readonly IRegistrarUsuService _registrarUsuRepository;
        public RegistrarUsuService(IRegistrarUsuService registrarUsuRepository)
        {
            _registrarUsuRepository = registrarUsuRepository;
        }
