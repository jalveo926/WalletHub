...
//Función para cargar las transacciones desde la API especificamente la lista que ve el usuario
async function cargarTransaccionesDesdeAPI() {
    try {
        ...
        await cargarCategorias(); // Actualizar la lista de categorías globales
        await cargarCategoriasCombobox("categoriaTransaccion", "tipoTransaccion"); // Cargar categorías en el combobox de creación de transacción
        configurarSlider();
